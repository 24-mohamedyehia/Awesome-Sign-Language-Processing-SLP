...
|:---|:---|:---|:---|:---:|
| Cross Modality Augmentation | Cross-modal augmentation | Video | Improve continuous recognition robustness | [Paper](https://dl.acm.org/doi/abs/10.1145/3394171.3413931) |
| Prior-Aware Cross Modality Augmentation Learning | Prior-aware augmentation | Video | Improve continuous recognition performance | [Paper](https://ieeexplore.ieee.org/document/10105511) |
| Cross-modality Data Augmentation for End-to-End Sign Language Translation | Cross-modal augmentation | Video | Improve end-to-end translation | [Paper](https://arxiv.org/pdf/2305.11096.pdf) |
| Automatic Gloss-level Data Augmentation for Sign Language Translation | Gloss-level augmentation | Gloss / Text | Improve translation data diversity | [Paper](https://aclanthology.org/2022.lrec-1.734.pdf) |
...
|:---|:---|:---|:---|:---:|
| FineHand | Hand shape learning | Video | Hand-centric features | [Paper](https://ieeexplore.ieee.org/document/9320289) |
| Hand Pose Guided 3D Pooling | Pose-guided representation | Video / Pose | Recognition features | [Paper](https://openaccess.thecvf.com/content/WACV2021/html/Hosain_Hand_Pose_Guided_3D_Pooling_for_Word-Level_Sign_Language_Recognition_WACV_2021_paper.html) |
| Pose-based SLR using GCN and BERT | Pose sequence modeling | Pose | Gloss / Class predictions | [Paper](https://openaccess.thecvf.com/content/WACV2021W/HBU/html/Tunga_Pose-Based_Sign_Language_Recognition_Using_GCN_and_BERT_WACVW_2021_paper.html) |
...
|:---|:---|:---|:---|:---:|
| SignAvatar | 3D motion reconstruction and generation | Video | 3D body/hand motion pipeline | [Project](https://dongludeeplearning.github.io/SignAvatar.html) |
| T2S-GPT | Text-to-sign motion generation | Text | Autoregressive sign motion | [Project](https://t2sgpt-demo.yinaoxiong.cn/) |
| G2P-DDM | Gloss-to-pose diffusion generation | Gloss | Pose sequence generator | [Project](https://slpdiffusier.github.io/g2p-ddm/) |
| SignGen | Video generation from sign representation | Latent sign tokens | Diffusion video generator | [Code](https://github.com/mingtiannihao/SignGen) |
| SOKE | Retrieval-enhanced multilingual generator | Text / Retrieval context | Token-based sign generation | [Code](https://github.com/2000ZRL/SOKE) |
...
| Note | Meaning |
|:---|:---|
| Keep the list task-first | Users should find resources by what they want to do |
| Prefer precise labels | Better names make later curation easier |
| Separate code and data | Models, datasets, tools, and papers should stay distinct |
| Leave room for growth | Empty rows are intentional placeholders |
...
## 🤝 Ethics & Community Co-Design

> Work focused on accessibility, Deaf-community participation, privacy, and responsible design.

| Resource | Theme | What it covers | Why it matters | Link |
|:---|:---|:---|:---|:---:|
| TBD | TBD | TBD | TBD | TBD |
